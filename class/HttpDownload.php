...
/* Modified by DDS: Added support for HTTP HEAD method required by some downloaders */
...
class httpdownload {
	...
	function download() {
		...
		$packet = 1;
		// DDS: if client requests headers, send just the headers, not the whole file		
